...
public final class MorrowEventAuthority {
    private static final Map<String, Definition> EVENTS = Map.ofEntries(
            ...
            event("morrow.act2.live_capture_authorized", "minecraft", "morrow.act2.behavior_reuse_proven"),
            event("morrow.act3.version_fragments_authenticated", "minecraft", "morrow.act2.live_capture_authorized"),
            event("morrow.act3.contradiction_preserved", "minecraft", "morrow.act3.version_fragments_authenticated"),
            event("morrow.act4.witness_anchor_registered", "minecraft", "morrow.act3.contradiction_preserved"),
