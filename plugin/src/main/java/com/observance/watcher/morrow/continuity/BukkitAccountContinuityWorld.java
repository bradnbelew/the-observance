...
/** Primary-thread Paper world port for the bounded M09 installer. */
public final class BukkitAccountContinuityWorld implements AccountContinuityInstaller.WorldPort {
    private final World world; private final Origin origin; private final String binding;
    public BukkitAccountContinuityWorld(World world, Origin origin) {
    ...
    private static void requirePrimaryThread() {
        if (!Bukkit.isPrimaryThread()) throw new IllegalStateException("M09 world access requires Paper's primary thread");
    }
}
