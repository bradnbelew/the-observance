...
/** Primary-thread Paper world port for the bounded M11 installer. */
public final class BukkitColdStorageWorld implements ColdStorageInstaller.WorldPort {
    private final World world; private final Origin origin; private final String binding;
    public BukkitColdStorageWorld(World world, Origin origin) {
    ...
    private static void requirePrimaryThread() {
        if (!Bukkit.isPrimaryThread()) throw new IllegalStateException("M11 world access requires Paper's primary thread");
    }
}
