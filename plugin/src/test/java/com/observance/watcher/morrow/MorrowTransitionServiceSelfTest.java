...
public final class MorrowTransitionServiceSelfTest {
    ...
    public static void main(String[] args) {
        ...
        List<List<String>> stages = List.of(
                ...
                List.of("morrow.act3.incomplete_consensus_proven", "morrow.act4.witness_anchor_registered", "morrow.act4.almost_home_proven", "morrow.act4.account_continuity_authorized"),
