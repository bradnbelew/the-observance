...
Write-Host ""
Write-Host "next: upload the plugin jar, install the datapack, host the resource zip, then set resource-pack.url and resource-pack.sha1 to the hosted bytes."
