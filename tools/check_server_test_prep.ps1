...
try {
  ...
  if (-not (Test-Path $guideFile)) {
    ...
    foreach ($needle in @(
      ...
      "prior_witness_ready",
      "where to type it",
      "require backtracking for evidence",
      ...
      "Failed Accepting is launch-blocking",
      "old camp/Failed Accepting gate",
      "old camp opens without",
