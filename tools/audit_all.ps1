...
foreach ($required in @(
  ...
  (Join-Path $tools "check_evidence_relationship_web.py"),
  ...
  (Join-Path $tools "check_p5_p12_external_bindings.py"),
...
Invoke-External "P5-P12 authored external evidence bindings" $root "python" @((Join-Path $tools "check_p5_p12_external_bindings.py"))
