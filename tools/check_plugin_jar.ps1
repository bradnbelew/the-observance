...
$authoritySources = [ordered]@{
  ...
  "v5/authority/ARG-P11-INDEPENDENT-IDENTITY-OVERLAY.json" = (Join-Path $RepoRoot "design\ARG-P11-INDEPENDENT-IDENTITY-OVERLAY.json")
  "v5/authority/ARG-P12-ANY-SUBSET-OVERLAY.json" = (Join-Path $RepoRoot "design\ARG-P12-ANY-SUBSET-OVERLAY.json")
