...
if ($failures.Count -eq 0) {
  ...
  RequireContains "SetupFlow.tsx" $setupFlow "tools\\check_hold_invitation.ps1"
  ...
  RequireContains "DirectorRunPanel.tsx" $directorRun "tools\\check_hold_invitation.ps1"
  ...
  RequireContains "DirectorStateReport.tsx" $directorState "address cipher packaged"
  RequireContains "DirectorStateReport.tsx" $directorState "listing withholds the live endpoint"
