-- PROPOSAL ONLY. Never apply to production until a disposable/development target passes this file,
-- its assertions, the rollback, the forward replay, and both Supabase advisors.
begin;
