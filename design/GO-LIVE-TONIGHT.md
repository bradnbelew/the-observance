...
> observance-0.2.2.jar`, 331 KB); lore reconciled; canon docs + the zero-manual `placeroom` command
...
## 2. PLUGIN
1. The jar is already built: **`plugin/build/libs/observance-0.2.2.jar`**. (To rebuild:
