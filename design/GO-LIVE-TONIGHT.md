...
> observance-0.1.0.jar`, 331 KB); lore reconciled; canon docs + the zero-manual `placeroom` command
...
## 2. PLUGIN
1. The jar is already built: **`plugin/build/libs/observance-0.1.0.jar`**. (To rebuild:
