...
values
  ...
  ('morrow.act3.incomplete_consensus_proven', 3, 'minecraft', '{morrow.act3.version_fragments_authenticated}', '{minecraft,copperline,discord}'),
  ('morrow.act4.witness_anchor_registered', 4, 'minecraft', '{morrow.act3.incomplete_consensus_proven}', '{minecraft,copperline}'),
