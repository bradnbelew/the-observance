...
| M02 | Six-cell Static Restore proposal, native classification, unsupported-block proof, rollback baseline, curious-state transition | Authority tests; latest-plugin fedac89 exact Paper build/restart and unobscured Room 04/terminal still; historical terminal-dialog activation | Full latest-plugin non-op correct/wrong/Escape visual interaction |
