...
| M02 | Six-cell Static Restore proposal, native classification, unsupported-block proof, rollback baseline, curious-state transition | Authority tests; exact Paper Room 04 build/restart; historical terminal-dialog activation; source-bound d2580fd Room 04/terminal still | Full latest-source non-op correct/wrong/Escape visual interaction |
...
| --- | --- | --- | --- |
| Minecraft | M01 handoff through M12 persistent coda, local-first journal, bounded worlds, native dialogs, body/replays, restart recovery | All twelve authorities; exact Paper runtime checkpoints; safe real-client cohort joins/restarts for 1/2/6; source-bound d2580fd Room 04/terminal render | Complete latest-source operator-free graphical playthrough and every interaction/parity lane |
