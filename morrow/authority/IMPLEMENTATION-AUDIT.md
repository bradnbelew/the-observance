...
| M02 | Six-cell Static Restore proposal, native classification, unsupported-block proof, rollback baseline, curious-state transition | Authority tests; latest-plugin 28c6810 exact Paper build/restart; native proposal dialog, readable receipt tooltip, and reversible Escape observed in a real vanilla client | Apply/review, correct/wrong, and receipt-producing latest-plugin visual interaction |
...
| --- | --- | --- | --- |
| Minecraft | M01 handoff through M12 persistent coda, local-first journal, bounded worlds, native dialogs, body/replays, restart recovery | All twelve authorities; latest-plugin 28c6810 exact Paper lifecycle, accelerated copper-aging stress/restart, and Room 04 native-dialog/Escape render; safe real-client cohort joins/restarts for 1/2/6 | Complete latest-plugin operator-free graphical playthrough and every remaining interaction/parity lane |
