...
('v5-ki03-iss-correction','C03 / Iss corrected account',array['iss signed the registrar out','iss signed the registrar out of the roster','iss removed the registrar from the roster'],'main_beat','{"voice_key":"oracleMainBeat","set_flags":{"v5_ki03_affidavit":true},"node_key":"KI03"}'::jsonb,2,true,8,'phrase','{"v5_ki02_keepsake":true}'::jsonb),
...
('v5-a10-private-window','C07 / private revision boundary',array['inside access sender unresolved','private revision crossed before public sender unknown'],'main_beat','{"voice_key":"oracleMainBeat","set_flags":{"v5_case_c07_complete":true},"node_key":"A10"}'::jsonb,4,true,8,'phrase','{"v5_a09_spool":true}'::jsonb),
