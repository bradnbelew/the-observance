...
values
  ...
  ('p5.service_chronology_shared','P5','{p4.control_reversal_earned}','{minecraft}','{minecraft,copperline,discord,npc}'),
  ('p5.civic_gallery_recurated','P5','{p5.service_chronology_shared}','{minecraft}','{minecraft,copperline,discord,npc}'),
  ('p6.professional_models_recovered','P6','{p5.civic_gallery_recurated}','{minecraft}','{minecraft,copperline,discord,npc}'),
  ('p6.six_responsibilities_acknowledged','P6','{p6.professional_models_recovered}','{minecraft}','{minecraft,copperline,discord,npc}'),
  ...
  ('p8.unlit_house_synthesis_completed','P8','{p7.nessa_publicly_cleared}','{minecraft}','{minecraft,copperline,discord,npc}'),
  ('p8.hold_systems_repaired','P8','{p8.intervention_plan_accepted,p8.unlit_house_synthesis_completed}','{minecraft}','{minecraft,copperline,discord,npc}'),
  ...
  ('p9.leak_window_proven','P9','{p9.company_biographies_restored}','{minecraft,copperline,media}','{minecraft,copperline,discord,media,npc}'),
