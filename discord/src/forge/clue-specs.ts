...
export const NON_CIPHER_KEYS: Readonly<Record<string, string>> = {
  ...
  'record-url': 'the founder line + Copperline service 1842 account trail pointing to its owner post and recovered Hold/Record copy (A13/A14); the downloaded walk, not the listing, owns the live endpoint reconstruction',
