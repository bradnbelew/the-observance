...
check("plain callback", relayCallbackMatches("9137"));
check("formatted callback", relayCallbackMatches("91-37"));
check("wrong callback", !relayCallbackMatches("9138"));
check("normalization", normalizeRelayCallback(" 91 37 ") === "9137");
