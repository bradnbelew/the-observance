...
async function LurePage() {
  ...
  return (
    <main className="mirror-site"><div className="mirror-page">
      ...
      <section className="mirror-note-block"><h2>uploader-note.txt</h2><p>This is the retained North Annex recovery image. Player data and chat were removed; the office records were left as filed.</p><p>The complete dispatch destination was never written into a single office copy. If the archive checksum does not match the index, do not merge it with another world.</p><p>— m.kept</p></section>
