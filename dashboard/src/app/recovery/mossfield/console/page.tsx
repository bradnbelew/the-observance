...
export default function MossfieldConsolePage() {
  ...
  return <LegacyShell active="support">
    ...
    <div className="old-alert"><b>Local only:</b> all fifteen gates are modeled below. G04-G06 now have a player-facing Paper rehearsal; live hosting, Discord, Supabase, director controls, and production remain disconnected.</div>
    ...
    <section className="old-copy"><h2>Runtime boundary</h2><ul className="old-checks"><li><b>Paper world</b><span>Arrival, Cairn&apos;s storehouse, and Rookery&apos;s cache are locally playable. G07-G15 world content, live hosting, and the shutdown route remain unbuilt.</span></li><li><b>Media</b><span>All twelve handmade assets need final files, hashes, custody notes, and accessible equivalents.</span></li><li><b>Discord</b><span>G10 safe fragments and post-shutdown silence need database-bound worker implementation.</span></li><li><b>Director</b><span>Controls remain disabled until allowlists, receipts, recovery, and finale arm/start are built.</span></li></ul></section>
