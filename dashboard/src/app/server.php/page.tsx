...
export default async function ServerDetailsPage({ searchParams }: { searchParams: Promise<{ id?: string }> }) {
  ...
  const liveAddress = process.env.NEXT_PUBLIC_OBSERVANCE_SERVER_ADDRESS?.trim();
