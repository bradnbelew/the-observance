...
export default async function RecoveredPacketPage() {
  ...
  return (
    <LegacyShell active="community">
      ...
      <section className="old-copy" id="evidence-p11-edition-margin" data-evidence-id="p11.e04"><h2>Edition margin and original hand</h2><p>The packet&apos;s intake image shows the same short return mark cut into the Hold&apos;s original filter register. A later council scan preserves the measurements but replaces the signer with <i>office copy</i>.</p><p>Mara&apos;s E3 margin carries one return instruction: compare the revision mark she left beside the route she tried to restore. The marked word supplies <b>V</b>. The other affidavits use their own work and must be checked at their surviving sources; this scan does not contain a name or a seventh office.</p></section>
